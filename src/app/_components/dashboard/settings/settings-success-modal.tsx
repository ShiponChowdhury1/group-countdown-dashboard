...
export default function SettingsSuccessModal({ open, onClose }: Props) {
  if (!open) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl text-center relative">
        ...
        <h2 className="text-2xl font-bold text-slate-900">Updated Successfully!</h2>
        <p className="mt-2 text-sm text-slate-500">Successfully updated</p>
